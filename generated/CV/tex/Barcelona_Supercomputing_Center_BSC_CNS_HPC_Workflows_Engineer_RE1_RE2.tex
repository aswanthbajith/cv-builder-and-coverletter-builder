...
M.Sc. student in High Performance Computing and Quantum Computing with a Mechanical Engineering foundation. Comfortable building high-performance computing, software engineering solutions — from low-level numerical code to production web features. Presented optimization findings to a 25-person seminar and received top marks. Reduced simulation runtime by 40% via vectorization on a 30,000-entity dataset. Looking for a research engineering position where I can apply my mix of engineering rigor and software development experience to solve real problems.
...
Performance Optimization, Scientific Machine Learning, Parallel and Distributed Systems, Scientific Software Engineering
