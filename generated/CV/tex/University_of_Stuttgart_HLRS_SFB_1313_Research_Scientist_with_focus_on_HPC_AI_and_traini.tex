...
M.Sc. student in High Performance Computing and Quantum Computing with a Mechanical Engineering foundation. Comfortable building high-performance computing, computational simulation, software engineering solutions — from low-level numerical code to production web features. Reduced simulation runtime by 40% via vectorization on a 30,000-entity dataset. Identified thermal runaway risk in battery simulation, leading to a design geometry change. Looking for a PhD position where I can apply my mix of engineering rigor and software development experience to solve real problems.
...
GPU Computing, High Performance Computing, Quantum Computing, Scientific Machine Learning
