...
M.Sc. student in High Performance Computing and Quantum Computing with a Mechanical Engineering foundation. Comfortable building high-performance computing, software engineering solutions — from low-level numerical code to production web features. Pushed test coverage from 45% to 78% in a production codebase as a working student. Reduced simulation runtime by 40% via vectorization on a 30,000-entity dataset. Looking for a master thesis position where I can apply my mix of engineering rigor and software development experience to solve real problems.
...
GPU Computing, Scientific Machine Learning, Parallel and Distributed Systems, Scientific Software Engineering
